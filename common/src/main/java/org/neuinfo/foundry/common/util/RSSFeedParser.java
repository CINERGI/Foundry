...
public class RSSFeedParser {
    ...
    public RSSFeedParser(String rssUrl) throws Exception {
        SAXBuilder builder = new SAXBuilder();

        Document doc = builder.build(new URL(rssUrl));
    ...
    public static class RSSFeed {
        ...
        public static RSSFeed fromXML(Element el) {
            ...
            if (el.getChild("pubDate") != null) {
                try {
                    rf.pubDate = sdf.parse(el.getChildTextTrim("pubDate"));
    ...
    public static class RSSItem {
        ...
        public static RSSItem fromXML(Element el) {
            ...
            if (el.getChild("pubDate") != null) {
                try {
                    ri.pubDate = sdf.parse(el.getChildTextTrim("pubDate"));
                } catch (ParseException e) {
                    e.printStackTrace();
                    ri.pubDate = null;
                }
