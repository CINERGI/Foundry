...
/**
 * Created by  valentine 10/22/2018.
 * Intended to be the first step in a workflow for edited records.
 *
 */
public class EditedRecordProcessor implements IPlugin {
    private String outDirectory;
    private final static Logger logger = Logger.getLogger(EditedRecordProcessor.class);
