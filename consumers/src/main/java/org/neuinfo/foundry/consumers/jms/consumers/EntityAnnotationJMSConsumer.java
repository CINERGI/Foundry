...
public class EntityAnnotationJMSConsumer extends JMSConsumerSupport implements MessageListener {
        ...
        if (theDoc != null) {
            ...
            if (origDoc != null && status != null && status.equals("new")) {
                ...
                try {
                    ...
                    // pi.putRelatedKeywords("status", "index_cp");
    ...
    public static void main(String[] args) throws Exception {
        ...
        Option propsOption = OptionBuilder.withArgName("entity-props-file").hasArg().
                withDescription("config properties file for the entity annotation consumer").create('p');
